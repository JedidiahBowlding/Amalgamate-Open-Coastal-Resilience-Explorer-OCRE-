...
Pilot scope note:
- Use CORA water levels (`fort.63`) for MVP trend/flooding analysis.
- Do not use wave products (`swan_DIR.63`, `swan_HS.63`, `swan_TPS.63`) for MVP decisions due to the v1.1 wave anomaly notice below.
